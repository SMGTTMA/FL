				...
				<div className="flex flex-col gap-6 p-6">
					...
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">
							...
							<Tooltip title="仅在大分辨率下可用 > 1600px (xl)">
					...
					{/* theme presets */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">预设主题</div>
					...
					{/* font */}
					<div>
						<div className="mb-3 text-base font-semibold text-text-secondary">字体</div>

						<div className="my-3 text-sm font-semibold text-text-disabled">字体系列</div>
						...
						<div className="my-3 text-sm font-semibold text-text-disabled">字体大小</div>
